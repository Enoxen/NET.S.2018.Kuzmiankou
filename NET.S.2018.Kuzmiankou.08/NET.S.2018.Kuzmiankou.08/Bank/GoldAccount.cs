...
namespace NET.S._2018.Kuzmiankou._08.Bank
{
    public class GoldAccount : BankAccount
    {
        ...
        /// </summary>
        private const int goldBonusDeposit = 900;
        /// <summary>
        /// Coefficient for bonus points
        /// </summary>
        private const int goldBonusWithdraw = 1400;
        ...
        public GoldAccount(ulong accountNumber, string name, string surname, double amountOfMoney = 0, int bonusPoints = 0) : base(accountNumber, name, surname, amountOfMoney, bonusPoints)
        {
        }
        /// <summary>
        ...
        {
            AddBonusPoints(money / goldBonusDeposit);
        ...
        {
            AddBonusPoints(money / goldBonusWithdraw);
